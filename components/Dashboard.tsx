      ...
      <div className="mt-8 px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
          <div className="flex items-start gap-3">
            <div className="bg-gradient-to-br from-cyan-400 to-blue-500 text-white rounded-lg p-3 flex-shrink-0">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm3.5-9c.83 0 1.5-.67 1.5-1.5S16.33 8 15.5 8 14 8.67 14 9.5s.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11zm3.5 6.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5z"/>
              </svg>
            </div>
            <div className="flex-1">
              <h4 className="font-bold text-gray-800 text-sm">New features unlocked</h4>
              <p className="text-gray-600 text-xs mt-1">Check out our latest banking features and updates</p>
              <button className="text-capitec-blue text-xs font-semibold mt-2">Learn more →</button>
            </div>
          </div>
        </div>
      </div>
